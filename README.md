...
#### 20251211 - ElevenLabs Hackathon
- **Directory**: [hackathons/20251211-elevenlabs/](hackathons/20251211-elevenlabs/)
...
- **Documentation**: [README.md](hackathons/20251211-elevenlabs/README.md)

#### 20251206 - Cursor Hackathon Malaysia
- **Directory**: [hackathons/20251206-cursor-my/](hackathons/20251206-cursor-my/)
...
- **Documentation**: [README.md](hackathons/20251206-cursor-my/README.md)

#### 20251109 - Drift Hackathon
- **Directory**: [hackathons/20251109-drift/](hackathons/20251109-drift/)
...
- **Documentation**: [README.md](hackathons/20251109-drift/README.md)

#### 20251031 - Singhacks
- **Directory**: [hackathons/20251031-singhacks/](hackathons/20251031-singhacks/)
...
- **Documentation**: [README.md](hackathons/20251031-singhacks/README.md)

#### 20251018 - Cursor Hackathon Singapore
- **Directory**: [hackathons/20251018-cursor/](hackathons/20251018-cursor/)
- **Description**: Full-stack application with comprehensive API documentation, architecture diagrams, and user guides.
- **Documentation**: [README.md](hackathons/20251018-cursor/README.md)
...
- **Documentation**: [README](personal/20251223-assistant/README.md)
  - [System Architecture](personal/20251223-assistant/architecture/system-architecture.md)
  - [Data Flow](personal/20251223-assistant/architecture/data-flow.md)
  - [Technical Learnings](personal/20251223-assistant/learnings/project-learnings.md)
...
2. Follow the project's README file for setup instructions
3. Refer to the detailed documentation files for architecture and feature information
...
- Each project typically includes:
  ...
  - Source code organized by component/feature
  - Configuration files for deployment and development

- Hackathon projects follow a time-stamped naming convention: `YYYYMMDD-projectname/`
...
- **Workspace License**: [MIT License](LICENSE)
